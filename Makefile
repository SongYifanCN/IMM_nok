...
imm_continuous: src/*.cpp src/*.h
	g++ -DCONTINUOUS src/imm.cpp -Wall -std=c++0x -O3 src/sfmt/SFMT.c  -o imm_continuous_nok

imm_discrete: src/*.cpp src/*.h
	g++ -DDISCRETE src/imm.cpp -Wall -std=c++0x -O3 src/sfmt/SFMT.c  -o imm_discrete_nok
